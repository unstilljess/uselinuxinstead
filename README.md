# You Should "Just" Use Linux Instead!
...
1. Person complains about a thing.
2. Hey, I know a way that they could fix the thing.
...
- Is this a complaining session or a request for help? If it's complaining, be friendly and understanding and sympathetic. Don't even bother with recommendations unless they ask.
- They want advice? Honestly ask and understand their underlying problems
    - Windows 11 doesn't support their hardware
    - "stick it to the man"
    - Privacy
    - Avoid AI
    - Remove bloat
